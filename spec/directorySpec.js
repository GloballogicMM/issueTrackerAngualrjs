describe('test direcories', function(){
   beforeEach(module('todo'));
    ...
    //another example declaring variables in directives testing
    /*
    ...
    */
    ...
    it ('should load slider', inject(function($templateCache){
        ...
        $rootScope.newTime = 3;
        var element = $compile('<div ui-slider ng-model="newTime"></div>')($rootScope);
